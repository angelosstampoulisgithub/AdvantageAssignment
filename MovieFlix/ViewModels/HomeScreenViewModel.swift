...
final class HomeScreenViewModel {
    ...
    var popularMovies: [MovieTableViewCellModel]?
    var searchResults: [MovieTableViewCellModel]?
    var favoriteMovies: [Int] = UserDefaults.standard.array(forKey: "Favorites") as? [Int] ?? []
    var page: Int = 0
